...
export abstract class Frame {
    ...
    abstract getFrameLength():number;
...
export class DataFrame extends Frame {
    ...
    */
    constructor(data:Buffer|Array<number>, direction?:number) {
        super();
    ...
    getDataChecksum() {
        var dataCopy = Array.from(this._data);
    ...
    toBuffer() {
        var array:number[] = [
            ...
            this.getDirection(), ...this._data, this.getDataChecksum(),POSTAMBLE];
