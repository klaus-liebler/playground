...
static createJournalItem(builder:flatbuffers.Builder, lastMessageTimestamp:bigint, messageCode:number, messageStringOffset:flatbuffers.Offset, messageData:number, messageCount:number):flatbuffers.Offset {
  JournalItem.startJournalItem(builder);
  JournalItem.addLastMessageTimestamp(builder, lastMessageTimestamp);
  JournalItem.addMessageCode(builder, messageCode);
