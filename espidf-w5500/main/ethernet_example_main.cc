...
constexpr httpd_uri_t uri_get = {"/uri", HTTP_GET, get_handler, nullptr};

void initETH(spi_host_device_t spiHost, gpio_num_t miso, gpio_num_t mosi, gpio_num_t sclk, uint32_t SPI_MASTER_FREQ_X, gpio_num_t reset, gpio_num_t cs, gpio_num_t irq, uint32_t phyAddress)
{
    ...
    phy_config_spi.reset_timeout_ms=300;
...
{
    initETH(SPI2_HOST, GPIO_NUM_13, GPIO_NUM_11, GPIO_NUM_12, SPI_MASTER_FREQ_20M, GPIO_NUM_21, GPIO_NUM_10, GPIO_NUM_14, 1);
